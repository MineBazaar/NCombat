package com.notpatch.nCombat.util;
...
public class StringUtil {
    ...
    public static String getColored(String path) {
        return hexColor(NCombat.getInstance().getConfig().getString(path));
    }

    public static String get(String path){
        return NCombat.getInstance().getConfig().getString(path);
    }

    public static Object get(Object path){
        return NCombat.getInstance().getConfig().get(path.toString());
    }
